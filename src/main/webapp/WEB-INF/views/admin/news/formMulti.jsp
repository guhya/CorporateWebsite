								...
								<div class="form-group row">
									...
									<div class="col-lg-4">
										<c:forEach begin="0" end="2" varStatus="i">
											...
											<p style="display:none"><img src="" id="imgmainImage_${i.index}" alt="mainImage_${i.index}"/></p>						
											<input type="file" id="mainImage_${i.index}" name="mainImage" title="file" class="file" onchange="showTempPic(this);" />										
											<p class="help-block">*Only (GIF, JPG, PNG).</p>
											</div>
										</c:forEach>
									</div>										
